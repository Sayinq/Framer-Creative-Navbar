            ...
            <AnimatePresence>
              {servicesHovered && (
                <motion.div
                  ...
                  className="absolute top-[15px] lg:w-[400px] h-[300px] mt-2"
                >
                  <div className="grid grid-cols-2 grid-rows-3 gap-y-[10px] gap-x-[10px] mt-10 w-full h-full">

                    <div className="col-span-1 row-span-1 rounded-lg hover:border-[0.5px] hover:border-[#F0EFEF]/60 hover:scale-[97%] hover:bg-[#e87c74] bg-[#F0EFEF] transition-all duration-200 ease-in-out">
                    ...
                    <div className="col-start-1 row-start-2 col-span-1 row-span-1 rounded-lg hover:border-[0.5px] hover:border-[#F0EFEF]/60 hover:scale-[97%] hover:bg-[#71e3d4] bg-[#F0EFEF] transition-all duration-200 ease-in-out">
                    ...
                    <div className="col-start-1 row-start-3 col-span-3 row-span-1 h-fit rounded-lg hover:border-[0.5px] hover:border-[#F0EFEF]/60 hover:scale-[97%] hover:bg-[#8671e3] bg-[#F0EFEF] transition-all duration-200 ease-in-out mr-[10px]">
                      <div className="flex flex-col justify-between w-full h-fit gap-y-2 p-2">
                        <h2>Custom Design</h2>
                        <p className="text-sm">Creating pixel-perfect designs that dazzle and delight your online audience.</p>
                      </div>
                    </div>

                    <div className="col-start-2 row-start-1 col-span-1 row-span-2 rounded-lg hover:border-[0.5px] hover:border-[#F0EFEF]/60 hover:scale-[97%] hover:bg-[#d16fde] bg-[#F0EFEF] transition-all duration-200 ease-in-out">
                      <div className="flex flex-col justify-center w-full h-full gap-y-2 p-2">
                        <h2>MVP Development</h2>
                        <p className="text-sm max-w-[150px]">Building your startup's big idea into a sleek and scalable MVP.</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
